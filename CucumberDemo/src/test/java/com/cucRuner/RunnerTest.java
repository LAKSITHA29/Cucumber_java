...
import io.cucumber.testng.AbstractTestNGCucumberTests;
import io.cucumber.testng.CucumberOptions;
@CucumberOptions(plugin = {"pretty","json:target/cucumber-reports/CucumberHRM.json", "html:target/cucumber-reports/Cucumber.html"},features="src\\test\\resources\\com\\features\\Login.feature",glue="stepDefinitions")
public class RunnerTest extends  AbstractTestNGCucumberTests{
